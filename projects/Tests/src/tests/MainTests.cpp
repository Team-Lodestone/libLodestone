...
#include "../../../Java/include/Lodestone.Java/mcr/region/McRegionRegionIo.h"
#include "Lodestone.Java/classic/minev2/MineV2World.h"
#include "../../../Java/include/Lodestone.Java/mcr/chunk/McRegionChunkIo.h"
...
namespace lodestone::tests::test {
    ...
    void MainTests::readMcrChunk() {
        ...
        java::mcr::chunk::McRegionChunkIO *io = (java::mcr::chunk::McRegionChunkIO*)level::conversion::chunk::ChunkIORegistry::sInstance.getChunkIO({"lodestone", "mcregion"});
        ...
        WRITE_FILE("minev2.mine.out", reinterpret_cast<const char*>(l2->write(w, lodestone::java::c0_0_12a)), l2->getSize(w, lodestone::java::c0_0_12a));
    }
    ...
    void MainTests::readMcrFile() {
        ...
        const lodestone::level::conversion::world::FileWorldIO *l2 = dynamic_cast<const lodestone::level::conversion::world::FileWorldIO*>(lodestone::level::conversion::world::WorldIORegistry::sInstance.getWorldIO({ "lodestone", "minev2" }));
        lodestone::java::classic::minev2::MineV2World *w = new lodestone::java::classic::minev2::MineV2World(std::unique_ptr<lodestone::level::Level>(r), "New World", "h");
        WRITE_FILE("minev2.mine.out", reinterpret_cast<const char*>(l2->write(w, lodestone::java::c0_0_12a)), l2->getSize(w, lodestone::java::c0_0_12a));
    }
}
