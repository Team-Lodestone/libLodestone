...
namespace lodestone::java::indev {
    ...
    std::unique_ptr<lodestone::level::Level> McLevelLevelIO::read(std::istream &in, int version) const {
    }

    void McLevelLevelIO::write(lodestone::level::Level *l, int version, std::ostream &out) const {
    }
