...
namespace lodestone::conversion::block {
    void version::BlockIO::registerBlock(const common::registry::Identifier *internal,
        data::AbstractBlockData *blk, const bool isDefault) {
        registerBlock(lodestone::level::block::BlockRegistry::getInstance().getBlock(internal), blk, isDefault);
    }
    ...
    void version::BlockIO::registerBlockIfNotExist(const common::registry::Identifier *internal,
    data::AbstractBlockData *blk, const bool isDefault) {
        registerBlockIfNotExist(level::block::BlockRegistry::getInstance().getBlock(internal), blk, isDefault);
    }

    data::AbstractBlockData *version::BlockIO::
    convertBlockFromInternal(const lodestone::level::block::properties::BlockProperties *b) {
    ...
    level::block::properties::BlockProperties version::BlockIO::convertBlockToInternal(const data::AbstractBlockData &b) {
