...
#define REG_PUT(r, n) lodestone::conversion::registry::r::getInstance().put(*n::getIdentifier(), std::make_unique<n>())
    ...
    void LodestoneJava::initBlocks() {
        ...
        m_blockIo.registerBlock(
            Version::in20091223_1457, &level::block::Blocks::NONE,
            new lodestone::conversion::block::data::NumericBlockData(0, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::STONE,
            new lodestone::conversion::block::data::NumericBlockData(1, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::GRASS_BLOCK,
            new lodestone::conversion::block::data::NumericBlockData(2, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::DIRT,
            new lodestone::conversion::block::data::NumericBlockData(3, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::COBBLESTONE,
            new lodestone::conversion::block::data::NumericBlockData(4, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::OAK_PLANKS,
            new lodestone::conversion::block::data::NumericBlockData(5, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::OAK_SAPLING,
            new lodestone::conversion::block::data::NumericBlockData(6, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::BEDROCK,
            new lodestone::conversion::block::data::NumericBlockData(7, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::FLOWING_WATER,
            new lodestone::conversion::block::data::NumericBlockData(8, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::WATER,
            new lodestone::conversion::block::data::NumericBlockData(9, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::FLOWING_LAVA,
            new lodestone::conversion::block::data::NumericBlockData(10, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::LAVA,
            new lodestone::conversion::block::data::NumericBlockData(11, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::SAND,
            new lodestone::conversion::block::data::NumericBlockData(12, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::GRAVEL,
            new lodestone::conversion::block::data::NumericBlockData(13, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::GOLD_ORE,
            new lodestone::conversion::block::data::NumericBlockData(14, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::IRON_ORE,
            new lodestone::conversion::block::data::NumericBlockData(15, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::COAL_ORE,
            new lodestone::conversion::block::data::NumericBlockData(16, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::OAK_LOG,
            new lodestone::conversion::block::data::NumericBlockData(17, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::OAK_LEAVES,
            new lodestone::conversion::block::data::NumericBlockData(18, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::SPONGE,
            new lodestone::conversion::block::data::NumericBlockData(19, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::GLASS,
            new lodestone::conversion::block::data::NumericBlockData(20, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::RED_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(21, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::ORANGE_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(22, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::YELLOW_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(23, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457,
            &minecraft::common::block::Blocks::CHARTREUSE_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(24, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::LIME_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(25, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457,
            &minecraft::common::block::Blocks::SPRING_GREEN_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(26, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::CYAN_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(27, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457,
            &minecraft::common::block::Blocks::LIGHT_BLUE_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(28, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457,
            &minecraft::common::block::Blocks::ULTRAMARINE_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(29, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::PURPLE_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(30, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::VIOLET_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(31, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::MAGENTA_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(32, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::PINK_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(33, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::GRAY_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(34, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457,
            &minecraft::common::block::Blocks::LIGHT_GRAY_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(35, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::WHITE_WOOL,
            new lodestone::conversion::block::data::NumericBlockData(36, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::DANDELION,
            new lodestone::conversion::block::data::NumericBlockData(37, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::POPPY,
        ...
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::RED_MUSHROOM,
            new lodestone::conversion::block::data::NumericBlockData(40, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::GOLD_BLOCK,
            new lodestone::conversion::block::data::NumericBlockData(41, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::IRON_BLOCK,
        ...
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::BRICKS,
            new lodestone::conversion::block::data::NumericBlockData(45, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::TNT,
            new lodestone::conversion::block::data::NumericBlockData(46, 0));
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::BOOKSHELF,
        ...
        m_blockIo.registerBlock(
            Version::in20091223_1457, &minecraft::common::block::Blocks::OBSIDIAN,
        ...
        m_blockIo.registerBlock(
            ...
            new lodestone::conversion::block::data::NumericBlockData(51, 0));
        m_blockIo.registerBlock(
            Version::in20100114,
            &minecraft::common::block::Blocks::WATER_SPAWNER,
            new lodestone::conversion::block::data::NumericBlockData(52, 0));
        m_blockIo.registerBlock(
            Version::in20100122_2251,
            &minecraft::common::block::Blocks::LAVA_SPAWNER,
            new lodestone::conversion::block::data::NumericBlockData(53, 0));
        m_blockIo.registerBlock(
            Version::in20100124_2119, &minecraft::common::block::Blocks::CHEST,
            new lodestone::conversion::block::data::NumericBlockData(54, 0));
        m_blockIo.registerBlock(
            Version::in20100128_2200, &minecraft::common::block::Blocks::GEAR,
            new lodestone::conversion::block::data::NumericBlockData(55, 0));
        m_blockIo.registerBlock(
            Version::in20100128_2200,
            &minecraft::common::block::Blocks::DIAMOND_ORE,
            new lodestone::conversion::block::data::NumericBlockData(56, 0));
        m_blockIo.registerBlock(
            Version::in20100128_2200,
            &minecraft::common::block::Blocks::DIAMOND_BLOCK,
            new lodestone::conversion::block::data::NumericBlockData(57,0));
        m_blockIo.registerBlock(
            Version::in20100129_2332,
            &minecraft::common::block::Blocks::CRAFTING_TABLE,
            new lodestone::conversion::block::data::NumericBlockData(58, 0));
        m_blockIo.registerBlock(
            Version::in20100206_2034, &minecraft::common::block::Blocks::WHEAT,
            new lodestone::conversion::block::data::NumericBlockData(59, 0));
        m_blockIo.registerBlock(
            Version::in20100206_2034,
            &minecraft::common::block::Blocks::FARMLAND,
            new lodestone::conversion::block::data::NumericBlockData(60, 0));
        m_blockIo.registerBlock(
            Version::in20100219, &minecraft::common::block::Blocks::FURNACE,
            new lodestone::conversion::block::data::NumericBlockData(61, 0));
        m_blockIo.registerBlock(
            Version::in20100219, &minecraft::common::block::Blocks::LIT_FURNACE,
            new lodestone::conversion::block::data::NumericBlockData(62, 0));
