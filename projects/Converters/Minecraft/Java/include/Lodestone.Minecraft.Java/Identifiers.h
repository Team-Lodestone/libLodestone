...
namespace lodestone::minecraft::java::identifiers {
    namespace io {
        namespace levelData {
            inline static constexpr lodestone::common::registry::Identifier
            ALPHA_LEVEL_DATA_IO = {
                "lodestone", "minecraft/java/io/level_data/alpha"};

            namespace nbt {
                inline static constexpr lodestone::common::registry::Identifier
                ALPHA_NBT_LEVEL_DATA_IO = {
                    "lodestone", "minecraft/java/io/nbt/level_data/alpha"};
            }
        }
    }
