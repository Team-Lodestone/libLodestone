...
namespace lodestone::minecraft::java::conversion::mcregion {
    ...
    class LODESTONE_MINECRAFT_JAVA_API McRegionLevelDataIO : public common::conversion::io::LevelDataIO<&identifiers::MCREGION_PLAYER_IO, const common::conversion::io::options::OptionPresets::CommonPlayerReadOptions, const lodestone::minecraft::common::conversion::io::options::OptionPresets::CommonWriteOptions>,
    ...
    class LODESTONE_MINECRAFT_JAVA_API McRegionNbtLevelDataIO : public common::conversion::io::NbtLevelDataIO<&identifiers::MCREGION_NBT_LEVEL_DATA_IO, const common::conversion::io::options::OptionPresets::CommonNbtFilesystemReadOptions, const lodestone::conversion::io::options::EmptyOptions>,
    public lodestone::conversion::registry::RegistryIdentifierRelations<
