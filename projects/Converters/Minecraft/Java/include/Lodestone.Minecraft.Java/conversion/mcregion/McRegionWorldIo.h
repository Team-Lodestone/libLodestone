...
namespace lodestone::minecraft::java::mcregion::world {
    ...
    public conversion::registry::RegistryIdentifierRelations< // allows us to do getByRelation<&identifiers::NBT_CHUNK_IO>() to get McRegionNbtChunkIO
        ...
        conversion::registry::RegistryIdentifierRelation<&lodestone::conversion::identifiers::REGION_IO, const region::McRegionRegionIO, &identifiers::MCREGION_REGION_IO, conversion::registry::RegionIORegistry>
    > {
      public:
