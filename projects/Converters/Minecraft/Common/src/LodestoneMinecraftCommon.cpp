...
#define MC_REGISTER_BLOCK_FUNC(n, m) r.registerBlockIfNonExistent(n, new level::block::Block(n, m))
    
    void LodestoneMinecraftCommon::initBlocks() {
        level::block::BlockRegistry &r = level::block::BlockRegistry::getInstance();

        MC_REGISTER_BLOCK_FUNC(&block::Blocks::STONE, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::GRASS_BLOCK,
                            level::material::Material({127, 178, 56, 255}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::DIRT, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::OAK_SAPLING,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::BEDROCK, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::FLOWING_WATER,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::WATER, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::FLOWING_LAVA,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::LAVA, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::SAND, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::GRAVEL, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::COAL_ORE,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::OAK_LOG, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::OAK_LEAVES,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::SPONGE, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::GLASS, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::DANDELION,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::POPPY, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::SMOOTH_STONE_SLAB,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::BRICKS, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::TNT, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::OBSIDIAN,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::ROPE, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::SANDSTONE,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::SNOW_LAYER,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::FIRE, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::ICE, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::QUARTZ_PILLAR,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::CRATE, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::STONE_BRICKS,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::TORCH, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::CHEST, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::GEAR, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::FARMLAND,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::WHEAT, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::FURNACE, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::LIT_FURNACE,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::OAK_DOOR,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::LADDER, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::OAK_SIGN,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::RAIL, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::IRON_DOOR,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::LEVER, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::SNOW_BLOCK,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::CACTUS, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::CLAY, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::SUGAR_CANE,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::JUKEBOX, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::GLOWSTONE,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::PUMPKIN, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::BIRCH_LOG,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::CAKE, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::NOTE_BLOCK,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::CORAL, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::BED, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::BIRCH_SAPLING,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::COBWEB, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::DEAD_BUSH,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::GRASS, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::FERN, level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::OAK_TRAPDOOR,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::PISTON, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::IRON_BARS,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::MELON, level::material::Material({0, 0, 0, 0}));
        ...
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::BROWN_MUSHROOM_BLOCK,
                            level::material::Material({0, 0, 0, 0}));
        MC_REGISTER_BLOCK_FUNC(&block::Blocks::VINE, level::material::Material({0, 0, 0, 0}));
