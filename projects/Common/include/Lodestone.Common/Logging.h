...
#define LOG_INFO_WIDE(...)                                                     \
    std::wcout << L"[" << FILE_NAME << L":" << __LINE__ << L" | " << __func__  \
               << L"/INFO] " << __VA_ARGS__ << std::endl

#define LOG_WARNING(...)                                                       \
    std::cout << "[" << FILE_NAME << ":" << __LINE__ << " | " << __func__      \
              << "/WARN] " << __VA_ARGS__ << std::endl

#define LOG_WARNING_WIDE(...)                                                  \
    std::cout << L"[" << FILE_NAME << L":" << __LINE__ << L" | " << __func__   \
              << L"/WARN] " << __VA_ARGS__ << std::endl
...
#define LOG_DEBUG(...)                                                         \
    std::cout << "[" << FILE_NAME << ":" << __LINE__ << " | " << __func__      \
              << "/DEBUG] " << __VA_ARGS__ << std::endl

#define LOG_DEBUG_WIDE(...)                                                    \
    std::wcout << L"[" << FILE_NAME << L":" << __LINE__ << L" | " << __func__  \
               << L"/DEBUG] " << __VA_ARGS__ << std::endl
