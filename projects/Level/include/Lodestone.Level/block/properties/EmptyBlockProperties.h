...
namespace lodestone::level::block::properties {
    ...
    public:
        ...
        const level::properties::AbstractProperty * getProperty(const std::string &id) const override;

        level::properties::AbstractProperty * getProperty(const std::string &id) override;

        void setProperty(const std::string &id, level::properties::AbstractProperty *property) override;

        const level::properties::AbstractProperty * operator[](const std::string &id) const override;

        level::properties::AbstractProperty * operator[](const std::string &id) override;
    };
}
