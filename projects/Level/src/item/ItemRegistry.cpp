...
namespace lodestone::level::item {
    ...
    bool ItemRegistry::registerItemIfNonExistent(const lodestone::common::registry::Identifier *id,
    ...
    const Item *ItemRegistry::getItem(const lodestone::common::registry::Identifier *id) const {
    ...
    const Item *ItemRegistry::operator[](const lodestone::common::registry::Identifier *id) const {
        return getItem(id);
    }
}