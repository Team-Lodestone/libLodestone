...
namespace lodestone::level::conversion::block {
    gtl::flat_hash_map<const registry::NamespacedString *, data::AbstractBlockData *> & version::BlockIO::
    getFromInternalConversionMap() {
        return mFromInternalConversionMap;
    }

    gtl::flat_hash_map<data::AbstractBlockData *, const registry::NamespacedString *, types::hash::BlockDataHash, types::hash::BlockDataComparator> & version::BlockIO::
    ...
    void version::BlockIO::registerBlock(const registry::NamespacedString *internal, data::AbstractBlockData *blk,
        const bool isDefault) {
        gtl::flat_hash_map<const registry::NamespacedString *, data::AbstractBlockData*> &c = getFromInternalConversionMap();
        gtl::flat_hash_map<data::AbstractBlockData*, const registry::NamespacedString *, types::hash::BlockDataHash, types::hash::BlockDataComparator> &i = getToInternalConversionMap();
    ...
    void version::BlockIO::registerBlockIfNotExist(const registry::NamespacedString *internal, data::AbstractBlockData *blk,
        const bool isDefault) {
        gtl::flat_hash_map<const registry::NamespacedString *, data::AbstractBlockData*> &c = getFromInternalConversionMap();
        gtl::flat_hash_map<data::AbstractBlockData*, const registry::NamespacedString *, types::hash::BlockDataHash, types::hash::BlockDataComparator> &i = getToInternalConversionMap();
    ...
    convertBlockFromInternal(const lodestone::level::block::state::BlockState *b) {
        const gtl::flat_hash_map<const registry::NamespacedString *, data::AbstractBlockData*> &m = getFromInternalConversionMap();
        const registry::NamespacedString *id = b->getBlock()->getID();
    ...
    level::block::state::BlockState version::BlockIO::convertBlockToInternal(data::AbstractBlockData *b) {
        ...
        thread_local lodestone::level::block::state::BlockState lastState = lodestone::level::block::state::BlockState(&lodestone::level::block::Blocks::AIR);

        const size_t hash = b->hash();
        if (hash == lastBlock)
            return lastState;

        const gtl::flat_hash_map<data::AbstractBlockData*, const registry::NamespacedString *, types::hash::BlockDataHash, types::hash::BlockDataComparator> &m = getToInternalConversionMap();
