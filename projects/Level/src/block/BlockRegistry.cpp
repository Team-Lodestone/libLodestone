...
namespace lodestone::level::block {
    ...
    BlockRegistry::BlockRegistry() {
        ...
        REGISTER_BLOCK_FUNC(&Blocks::SANDSTONE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::SNOW_LAYER, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::FIRE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::ICE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::CERAMIC_TILE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::MAGMA_BLOCK, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::QUARTZ_PILLAR, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::CRATE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::STONE_BRICKS, material::Material({0, 0, 0, 0}));
        ...
        REGISTER_BLOCK_FUNC(&Blocks::DIAMOND_BLOCK, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::CRAFTING_TABLE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::FARMLAND, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::WHEAT, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::FURNACE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::LIT_FURNACE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::OAK_DOOR, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::LADDER, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::OAK_SIGN, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::RAIL, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::MOB_SPAWNER, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::COBBLESTONE_STAIRS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::OAK_STAIRS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::IRON_DOOR, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::LEVER, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::REDSTONE_DUST, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::REDSTONE_TORCH, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::STONE_BUTTON, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::STONE_PRESSURE_PLATE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::OAK_PRESSURE_PLATE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::SNOW_BLOCK, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::CACTUS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::CLAY, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::SUGAR_CANE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::JUKEBOX, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::OAK_FENCE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::NETHERRACK, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::SOUL_SAND, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::GLOWSTONE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::PUMPKIN, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::GLOWING_PUMPKIN, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::NETHER_PORTAL, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::BIRCH_LEAVES, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::BIRCH_LOG, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::CAKE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::DISPENSER, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::LAPIS_BLOCK, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::NOTE_BLOCK, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::CORAL, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::BED, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::REDSTONE_REPEATER, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::PETRIFIED_OAK_SLAB, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::SANDSTONE_SLAB, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::SEAMLESS_STONE_SLAB, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::APRIL_FOOLS_CHEST, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::BIRCH_SAPLING, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::COBWEB, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::DETECTOR_RAIL, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::POWERED_RAIL, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::SPRUCE_SAPLING, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::DEAD_BUSH, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::GRASS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::FERN, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::OAK_TRAPDOOR, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::PISTON, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::STICKY_PISTON, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::PISTON_HEAD, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::BRICK_SLAB, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::BRICK_STAIRS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::STONE_BRICK_SLAB, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::STONE_BRICK_STAIRS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::CRACKED_STONE_BRICKS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::MOSSY_STONE_BRICKS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::INFESTED_STONE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::INFESTED_COBBLESTONE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::INFESTED_STONE_BRICKS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::GLASS_PANE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::OAK_FENCE_GATE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::IRON_BARS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::MELON, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::MELON_STEM, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::PUMPKIN_STEM, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::MUSHROOM_BLOCK, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::MUSHROOM_STEM, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::RED_MUSHROOM_BLOCK, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::BROWN_MUSHROOM_BLOCK, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::VINE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::BREWING_STAND, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::CAULDRON, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::DRAGON_EGG, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::ENCHANTMENT_TABLE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::END_PORTAL, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::END_PORTAL_FRAME, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::END_STONE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::LILY_PAD, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::MYCELIUM, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::NETHER_BRICKS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::NETHER_BRICK_FENCE, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::NETHER_BRICK_STAIRS, material::Material({0, 0, 0, 0}));
        REGISTER_BLOCK_FUNC(&Blocks::NETHER_WART, material::Material({0, 0, 0, 0}));
    }
